...
const handleMenu = ()=>{
  ...
  return (
    ...
    <div className=' hidden mx-[136px] lg:flex items-center justify-between py-[33px] '>
        ...
        <nav>
            <ul className='font-medium text-[15px] flex gap-5  cursor-pointer'>
               ...
               <Link href='/#contact ' className={'hover:text-[#62826B]'} nome={'Home'}>Contact Us</Link>
            </ul>
        </nav>          
    ...
    {/*Menu mobile*/}
        ...
        <Link href='https://wa.me/5511999999999' target='_blank'  className='p-2 border border-[#3837374c] rounded-full hover:text-[#62826B] px-4 text-cente w-fit h-fit text-[14px]'>Join class</Link>

        <Link href='https://wa.me/5511999999999' target='_blank' className='p-3 border border-[#3837374c] rounded-full hover:text-[#62826B] w-fit h-fit'><Image src={'/phone.svg'} alt='phone' width={24} height={24}/></Link>
